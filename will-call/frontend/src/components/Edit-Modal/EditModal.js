...
import {
  Box, Button, Typography, Modal, Grid, Paper, TextField, InputLabel, Select, MenuItem,
} from "@mui/material";
...
export default function EditModal({ ticket, handleUpdateTicket, noTM }) {
  ...
  return (
    ...
    >
      <Button
        sx={ EditStyle.editModalButton }
        onClick={ handleOpen }
      >
        <MoreHorizIcon
          sx={ EditStyle.threeDots }
        />
      </Button>
      <Modal
        open={ open }
      ...
      >
        ...
        >
          <Grid>
            <Paper
              elevation={ 20 }
              style={ EditStyle.paper }
            >
              <Grid
                align="center"
              />
              <form
                onSubmit={ (e) => { updateTicketHandler(e); } }
              >
                <Typography
                  variant="h5"
                  sx={ EditStyle.formtext }
                >
                  Team Member
                </Typography>
                <InputLabel
